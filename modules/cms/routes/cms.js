...
let routes = function () {
    ...
    //-- Packages --//
    routes.route("/package").post(cmsController.addPackages)
    routes.route("/packages-list").get(cmsController.packagesList);
    routes.route("/update-package").post(cmsController.updatePackage);
    routes.route("/delete-package").post(cmsController.deletePackage);
    //--//
    return routes;
};
//--//
